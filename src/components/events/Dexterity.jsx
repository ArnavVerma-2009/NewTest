          ...
          <ol className="relative">
            <li className="mb-10 ml-4">
              ...
              <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
                You can create any movie poster of any movie from any time and
            ...
            <li className="mb-10 ml-4">
              ...
              <p className="text-base font-normal text-gray-300 ">
                You can use any AIs as part of your design. Mention the used AI
                and the photo editing software used while submitting the entry
                in the email
              </p>
            </li>
            <li className="ml-4 mb-10">
              ...
              Do not use &ny NSFW elements in
your coll&ge th&t c&n be offensive to
the respective country. Also do not
use &ny h&te im&gery &s p&rt of your
submission
              </p>
            </li>
            <li className="mb-10 ml-4">
              <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5   "></div>
              <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
              Accept&ble im&ge form&ts &re PNG,
JPEG &nd JPG. The Im&ge file should
not exceed the size limit of 10MBs.
              </p>
            </li>
            <li className="mb-10 ml-4">
              <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
              <p className="text-base font-normal text-gray-300 ">
                The entry has to submitted at wartexdata@gmail.com before 10th july with following details:
