              ...
              <p className="date sm:hidden block md:text-sm text-xs  text-left font-semibold ml-4 leading-6 text-white  uppercase">
                26 OCTOBER, 2023
                  ...
                  <div className="mt-8 sm:mt-4 flex items-center justify-center gap-x-6 flex-col md:flex-row">
                   <div className="mb-4 gap-2 sm:mb-0 sm:gap-0 flex flex-col sm:flex-row">
                    <Link
                      to="https://discord.gg/QkDqt6fp"
                      className="mr-4  akira border-2 tracking-widest line text-sm  transition ease-in-out duration-[1s]  border-[#fff] rounded-full font-semibold px-4 py-2.5  text-white cursor-pointer hover:bg-[#5864F2] hover:border-white hover:text-[#fff] "
                    >
                      DISCORD
                    </Link>
                    <Link
